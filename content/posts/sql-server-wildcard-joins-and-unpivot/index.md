...
date: 2026-09-05T10:30:00+07:00
draft: false
...
rules matches every account in the batch: not one, but all of them. This isn't
a hypothetical. I ran it:

| Input | Result |
|---|---|
| 20,000 accounts, 4,000 rules (~28% of rules leave a field blank) | n/a |
...
|---|---|---|---|
| No index, `OR` chain (baseline) | 1,614.6 ms | 1.00× | Table Scan |
...
and the data table grow, so know your blank-field ratio before you trust a
