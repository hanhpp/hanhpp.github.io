...
their first real mistake: they open a discussion about *technology*
(REST vs. gRPC vs. Kafka) before they've settled a much more basic
question. Two
questions, really:
...
(one line waits for the previous one), so it's the natural first choice
when moving off a monolith.
